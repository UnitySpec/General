...
namespace UnityFlow.General.Configuration
{
    public class ConfigurationLoader : IConfigurationLoader
    {
        ...
        public SpecFlowConfiguration Load(SpecFlowConfiguration specFlowConfiguration, ISpecFlowConfigurationHolder specFlowConfigurationHolder)
        {
            ...
            {
                case ConfigSource.Default: return GetDefault();
                case ConfigSource.AppConfig: return LoadAppConfig(specFlowConfiguration, ConfigurationSectionHandler.CreateFromXml(specFlowConfigurationHolder.Content));
                case ConfigSource.Json: return LoadJson(specFlowConfiguration, specFlowConfigurationHolder.Content);
